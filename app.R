...
library(reactablefmtr)   # Formatting for reactable
...
GEMINI_API_KEY <- 'AIzaSyCfNaT02UDwdBgwuG1dP7jupUk-s2Sg3R4'
                 ...
                 wellPanel(
                   fluidRow(
                     ...
                     column(
                       ...
                       actionButton("run_globe", "Search Dest", icon = icon("globe"), class = "btn btn-success"),
